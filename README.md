...
### Challenge Map
Visual/text representation of how challenges connect:
- Docking Bay (entry point) → branches to other modules → final AI Core
...
**Locked State:**
![Docking Bay - Locked](images/docking_bay_locked.png)

**Access Granted:**
![Docking Bay - Access Granted](images/docking_bay_success.png)
